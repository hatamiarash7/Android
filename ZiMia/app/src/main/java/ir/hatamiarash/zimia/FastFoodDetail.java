...
public class FastFoodDetail extends ListActivity {
    ...
    private TextView fastfood_name;
    private TextView fastfood_open_hour;
    private TextView fastfood_close_hour;
    private TextView fastfood_address;
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (is_open) {
                    ...
                    i.putExtra(Config_TAG.TAG_TYPE_ITEM, "FastFood_Foods");
